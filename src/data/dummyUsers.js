...
export const uploadDummyDataToFirebase = async () => {
  const FIXED_DUMMY_USERS = [
    ...
    { id: 'dummy_3', name: 'Isha', age: 26, job: 'Designer', bio: 'Just a small town girl living in a lonely world.', interests: ['Art', 'Photo', 'Travel'], gender: 'Female', lookingFor: 'No commitment', religion: 'Hindu', location: 'India', photos: ['https://randomuser.me/api/portraits/women/3.jpg'] },
    ...
    { id: 'dummy_9', name: 'Saanvi', age: 22, job: 'Content Creator', bio: 'Not here for hookups.', interests: ['photos', 'Fashion', 'Travel'], gender: 'Female', lookingFor: 'Long time partner', religion: 'Hindu', location: 'India', photos: ['https://randomuser.me/api/portraits/women/9.jpg'] },
    ...
    { id: 'dummy_14', name: 'Kavya', age: 22, job: 'Model', bio: 'Fitness freak.', interests: ['Fitness', 'Fashion', 'photos'], gender: 'Female', lookingFor: 'Hook up type', religion: 'Hindu', location: 'India', photos: ['https://randomuser.me/api/portraits/women/14.jpg'] },
    { id: 'dummy_15', name: 'Khushi', age: 23, job: 'Photographer', bio: 'Bookworm.', interests: ['photos', 'Reading', 'Travel'], gender: 'Female', lookingFor: 'Still figuring it out', religion: 'Hindu', location: 'India', photos: ['https://randomuser.me/api/portraits/women/15.jpg'] },
    ...
    { id: 'dummy_22', name: 'Vani', age: 24, job: 'Writer', bio: 'Collecting moments, not things.', interests: ['Writing', 'Travel', 'photos'], gender: 'Female', lookingFor: 'Chill type', religion: 'Hindu', location: 'India', photos: ['https://randomuser.me/api/portraits/women/22.jpg'] },
